let raspored = (function () {
	...
	var imalDana = function (raspored, dan) {
	...
	var dajPlaniranuPoziciju = function (raspored, vrijemePocetak, dan) {
		var table = raspored.getElementsByTagName("table")[0];
	var redovi = table.getElementsByTagName("tr");
	var planiranaPoz = 0;
	for (let red of redovi) {
	...
	var popraviOkvir = function (raspored) {
		var table = raspored.getElementsByTagName("table")[0];
		var redovi = table.getElementsByTagName("tr");
		for (let red of redovi) {
